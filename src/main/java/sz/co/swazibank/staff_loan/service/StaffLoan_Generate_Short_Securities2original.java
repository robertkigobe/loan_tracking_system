...
public class StaffLoan_Generate_Short_Securities2original extends AbstractPdfView {
...
///////////date month and year for application date//////
		...
		float otherDeductions = theStaffLoan.getOtherDeductions();
		float insurancesDeductions = theStaffLoan.getInsurancesDeductions();
		float cityCouncilRatesDeductions = theStaffLoan.getCityCouncilRatesDeductions();
		float educationalloanDeductions = theStaffLoan.getEducationalLoanDeductions();
		float personalloanDeductions = theStaffLoan.getPersonalLoanDeductions();
		float carloanDeductions = theStaffLoan.getCarLoanDeductions();
		float farm_smallHolderDeductions = theStaffLoan.getFarm_smallHolderDeductions();
		float ruralHousingloanDeductions = theStaffLoan.getRuralHousingLoanDeductions();
		float housingloanDeductions = theStaffLoan.getHousingloanDeductions();
		float otherBalance = 0;
		float insurancesBalance = theStaffLoan.getInsurancesBalance();
		float cityCouncilRatesBalance = theStaffLoan.getCityCouncilRatesBalance();

		float educationalloanBalance = theStaffLoan.getEducationalLoanBalance();
		float personalloanBalance = theStaffLoan.getPersonalLoanBalance();
		float carloanBalance = theStaffLoan.getCarLoanBalance();
		float farm_smallHolderBalance = theStaffLoan.getFarmSmallHolderBalance();
		float ruralHousingloanBalance = theStaffLoan.getRuralHousingLoanBalance();
		float housingloanBalance = theStaffLoan.getHousingloanBalance();

		float allowances = theStaffLoan.getAllowances();
		float basicSalary = theStaffLoan.getBasic_salary();

		float otherDeductionsExcLeaveAllowance = theStaffLoan.getOtherDeductionsExcLeaveAllowance();
		float targetSavings = theStaffLoan.getTargetSavings();
		float statutoryDeductions = theStaffLoan.getStatutoryDeductions();
